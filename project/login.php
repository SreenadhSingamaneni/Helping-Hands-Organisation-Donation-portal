...
$cookie_value= $_REQUEST['user_name'];
...
<body>
	...
	<div id="box">
		...
		<form method="post">
			<div style="font-size: 20px;margin: 10px;color: white;"><center><h3>LOGIN</h3></center></div>
			...
			<button style="float:right;"><a href="signup.php" style="text-decoration:none;">Register</a></button><br><br>
		</form>
	</div>
</body>
</html>